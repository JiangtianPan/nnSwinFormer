...
parser.add_argument("--noise_config", default={"type": "random", "ratio": 0.2}, type=dict, help="Configuration for label noise injection")
# parser.add_argument("--noise_config", default={}, type=dict, help="Configuration for label noise injection")
